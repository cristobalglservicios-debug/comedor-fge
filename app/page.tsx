  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center">
        ...
        <p className="mt-6 text-slate-400 text-xs font-bold tracking-[0.3em] uppercase animate-pulse">Iniciando Seguridad</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-between p-8 font-sans">
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-sm">
        ...
        {/* CONTENEDOR DEL LOGO OFICIAL LOCAL */}
        <div className="mb-10 animate-fade-in">
          <div className="bg-white w-36 h-36 rounded-full flex items-center justify-center shadow-2xl shadow-slate-200 border border-slate-50 p-1">
            <img 
              src="/Logo-FGE.jpg" 
              alt="Logo FGE Yucatán"
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-500 text-sm font-bold pt-2 tracking-tight">
            {userProfile 
        ...
        <button 
          onClick={handleStart}
          className="group mt-14 w-full bg-[#1A2744] text-white p-5 rounded-3xl font-bold flex items-center justify-between shadow-2xl shadow-blue-900/40 active:scale-[0.97] transition-all"
        >
          <span className="ml-4 tracking-[0.2em] text-[10px] uppercase font-black">
            {userProfile ? 'Acceder al Panel' : 'Ingresar al Sistema'}
          </span>
          <div className="bg-[#C9A84C] p-2 rounded-xl transition-transform group-hover:translate-x-1">
